"""Modul pembuatan kartu siswa PNG - Penn State LionPATH"""
import random
...
def generate_html(first_name, last_name, school_id='2565'):
    """
    Generate HTML Penn State LionPATH
...
def generate_image(first_name, last_name, school_id='2565'):
    """
    Generate screenshot PNG Penn State LionPATH
    ...
    try:
        ...
        # Screenshot dengan Playwright (pengganti Selenium)
        with sync_playwright() as p:
            browser = p.chromium.launch(headless=True)
            page = browser.new_page(viewport={'width': 1200, 'height': 900})
            page.set_content(html_content, wait_until='load')
            page.wait_for_timeout(500)  # tunggu style load
...
if __name__ == '__main__':
    ...
    print("Uji pembuatan gambar PSU...")
