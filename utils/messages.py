...
def get_about_message() -> str:
    ...
    return (
        ...
        "\n"
        "功能介绍:\n"
        "- 自动完成 SheerID 学生/教师/军人认证\n"
        "- 支持 Gemini One Pro、ChatGPT Teacher K12、Spotify Student、YouTube Student、Bolt.new Teacher、Military 认证\n"
        "\n"
        "积分获取:\n"
        "- 注册赠送 1 积分\n"
        "- 每日签到 +1 积分\n"
        ...
        "使用方法:\n"
        "1. 在网页开始认证并复制完整的验证链接\n"
        "2. 发送 /verify、/verify2、/verify3、/verify4、/verify5 或 /verify6 携带该链接\n"
        "3. 等待处理并查看结果\n"
...
def get_help_message(is_admin: bool = False) -> str:
    ...
    msg = (
        ...
        f"/verify6 <链接> - Military 认证（-{VERIFY_COST}积分）\n"
