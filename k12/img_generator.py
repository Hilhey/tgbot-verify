...
def _render_template(first_name: str, last_name: str) -> str:
    """Baca template, ganti nama/ID/tanggal, dan expand variabel CSS."""
    ...
    # Expand variabel CSS agar kompatibel dengan xhtml2pdf
    color_map = {
    ...
    # Ganti nama/ID/tanggal contoh (muncul dua kali di template + span)
...
def generate_teacher_pdf(first_name: str, last_name: str) -> bytes:
    """Generate bytes dokumen PDF bukti guru."""
...
def generate_teacher_png(first_name: str, last_name: str) -> bytes:
    """Buat PNG lewat screenshot Playwright (butuh playwright + chromium terpasang)."""
    try:
    ...
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(500)  # tunggu style stabil
...
# Kompatibilitas lama: default menghasilkan PDF
